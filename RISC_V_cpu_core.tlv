...
\TLV
   ...
   `BOGUS_USE($rs1_valid $rs2_valid $funct3_valid $rd_valid $imm_valid);
   ...
   //$rf1_rd_index1[4:0] = $rs1;
   //$rf1_rd_index2[4:0] = $rs2;
   //$rf1_rd_index2[4:0] = $rs2;
   
   //$src1_value = $rf1_rd_index1;
   //$src2_value = $rf1_rd_index2;
   
   //SLTU and SLTI (set if less than, unassigned) results:
   $sltu_rslt[31:0] = { 31'b0, $src1_value < $src2_value };
   $sltiu_rslt[31:0] = { 31'b0, $src1_value < $imm };
   
   //SRA and SRAI (shisft right, arithmetic) results:
   // sign - extended src1
